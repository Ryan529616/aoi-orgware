...
| Codex hook receipt capacity | A full immutable v1 store can be adopted into a bounded v2 generation ledger only through read-only preview plus Chief-fenced exact apply. Legacy bytes remain in place; sealed generations are retained, never evicted or compacted automatically |
