...
Status: active implementation contract, evidence checkpoint 2026-07-22
...
- Completion boundary: A clean containing successor of rejected exact commit
  ...
  No push, remote CI, release, package/artifact publication, connector export,
  or ARISE RTL/EDA execution is permitted. Only after those gates may ARISE AOI
  be backed up and the exact reviewed version installed side-by-side with
  Windows-to-WSL hook reachability, then stop.
